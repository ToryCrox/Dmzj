package com.tory.dmzj.networks.glidemodule;
...
import com.tory.dmzj.networks.OkHttpManager;
...
public class OkHttpGlideModule implements GlideModule {
    ...
    public void registerComponents(Context context, Glide glide) {
        glide.register(GlideUrl.class, InputStream.class,
                new OkHttpUrlLoader.Factory(OkHttpManager.Companion.getInstance().getMOkHttpClient()));
    }
}
